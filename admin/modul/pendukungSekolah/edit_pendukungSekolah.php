    ...
    <div class="container mt-3">
        <div class="card">
            ...
            if (isset($_POST['updatePendukung'])) {
                $sql = mysqli_query($koneksi, "UPDATE tb_pendukungsekolah SET file_akreditasi='$_POST[file_akreditasi]',file_kurikulum='$_POST[file_kurikulum]' WHERE id_pendukungsekolah='$_POST[id_pendukungsekolah]' ") or die(mysqli_error($koneksi));
