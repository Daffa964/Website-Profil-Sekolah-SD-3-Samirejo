<div class="container mt-3">
    <div class="card">
        <h5 class="card-header text-center">Form Input Tambah Data Pengumuman</h5>
        <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Judul Pengumumam</label>
                ...
                <button name="savePengumuman" type="submit" class="btn btn-primary mr-2">Simpan</button>
                <?php
